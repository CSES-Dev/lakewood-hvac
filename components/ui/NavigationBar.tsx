...
export default function NavigationBar() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full z-49 flex justify-between items-center px-6 pt-4 pb-6 w-full h-[17vh] text-xl font-medium bg-[#1E1E1E] text-[#F0F0F0]">
