...
import ImageUploadForm from "@/app/adminpanel/components/ServiceTable/components/ImageUploadForm";
...
export default function ServiceModal({ mode, initialData, onClose, onSuccess }: ServiceModalProps) {
    const {
        register,
        handleSubmit,
        setValue,
            ...
            <div className="bg-white p-6 rounded-lg w-full max-w-md relative">
                ...
                >
                    ...
                    <div>
                        ...
                        />
                        {errors.description && (
                            <p className="text-red-600 text-sm">Description required</p>
                        )}
                    </div>
