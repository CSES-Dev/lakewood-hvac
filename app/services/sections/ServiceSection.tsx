    ...
    return (
        <div>
            <ServiceItem
                ...
                description="At Lakewood Heating and Air Conditioning Inc., we pride ourselves on
            ...
            <ServiceItem
                title="Heating"
                description="Lakewood Heating and Air Conditioning Inc. is your reliable partner for
            ...
            <ServiceItem
                title="Thermostats"
                description="Our thermostat services include professional installation, maintenance,
            ...
            <ServiceItem
                title="Heat Pumps"
                description="Lakewood Heating and Air Conditioning Inc. offers comprehensive heat
