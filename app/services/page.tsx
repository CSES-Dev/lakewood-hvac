        ...
        <main className="bg-background px-[6.11vw] pt-[5.28vw] pb-[5vw] p-[0.69vw]">
            <div className="pb-[5vw]">
                <div className="text-[#F0F0F0] font-sans">
                    <h1 className="text-[6.25vw] ">Services</h1>
                    <p className="text-[2.22vw]">
            ...
            <div>
                <div className="text-[#F0F0F0] font-sans flex max-lg:flex-col w-full max-md:items-center max-sm:items-center max-container gap-[3.4vw]">
                    <div className="w-[33.33] flex-none flex rounded-[1.74vw]">
                        <Image
                            src="/ac.png"
                            alt="AC Image"
                            width={424}
                            height={424}
                            className="w-[29vw] h-[29vw]"
                        />
                    </div>
                    <div className="flex w-[66.67] flex-1 flex-col">
                        <p className=" pb-[1.67vw] text-[4.51vw]">Air Conditioning</p>
                        <p className=" pb-[2.22vw] text-[1.67vw]">
                        ...
                        <div>
                            <button className="text-[1.74vw] bg-primary rounded-[1.39vw] py-[1.04vw] px-[1.94vw]">
                                Schedule Today
                            </button>
                        </div>
                    </div>
                ...
                <div className="py-[5vw] text-[#F0F0F0] font-sans flex max-lg:flex-col w-full max-md:items-center max-sm:items-center max-container gap-[3.4vw]">
                    ...
                    <div className="flex w-[66.67] flex-1 flex-col">
                        <p className=" pb-[1.67vw] text-[4.51vw]">Heating</p>
                        <p className=" pb-[2.22vw] text-[1.67vw]">
                ...
                <div className="py-[5vw] text-[#F0F0F0] font-sans flex max-lg:flex-col w-full max-md:items-center max-sm:items-center max-container gap-[3.4vw]">
                    ...
                    <div className="flex w-[66.67] flex-1 flex-col">
                        <p className=" pb-[1.67vw] text-[4.51vw]">Thermostats</p>
                        <p className=" pb-[2.22vw] text-[1.67vw]">
                ...
                <div className="py-[5vw] text-[#F0F0F0] font-sans flex max-lg:flex-col w-full max-md:items-center max-sm:items-center max-container gap-[3.4vw]">
                    ...
                    <div className="flex w-[66.67] flex-1 flex-col">
                        <p className=" pb-[1.67vw] text-[4.51vw]">Heat Pumps</p>
                        <p className=" pb-[2.22vw] text-[1.67vw]">
